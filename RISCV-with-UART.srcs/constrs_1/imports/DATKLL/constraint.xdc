...
# create_clock -add -name clk_5_pin -period 200.00 -waveform {0 100} [get_ports { clk_5 }];
# create_clock -add -name clk_125_pin -period 8.00 -waveform {0 4} [get_ports { clk_125 }];
# create_clock -add -name rx_clk_pin -period 6510 -waveform {0 3255} [get_ports { rxClk }];
# create_clock -add -name tx_clk_pin -period 104166 -waveform {0 52083} [get_ports { txClk }];
# create_generated_clock -name rxClk -source [get_ports  SYS_clk] -divide_by 406 [get_pins  generatorInst/rxClk_reg/Q ]
# create_generated_clock -name txClk -source [get_ports  SYS_clk] -divide_by 6510 [get_pins generatorInst/txClk_reg/Q ]


## Switches
set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { INS_DATA_sw }]; #IO_L7N_T1_AD2N_35 Sch=SW0
...
set_property -dict { PACKAGE_PIN G17    IOSTANDARD LVCMOS33 } [get_ports { INS_DATA_sel }]; #IO_L16P_T2_35 Sch=LED4_G
...
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { CPU_execute_enable }]; #IO_L6P_T0_34 Sch=LED1
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { CPU_finish_execution }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
# set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { INS_DATA_sel }]; #IO_L23P_T3_35 Sch=LED3
...
set_property -dict { PACKAGE_PIN L20    IOSTANDARD LVCMOS33 } [get_ports { terminate_interrupt_button }]; #IO_L9N_T1_DQS_AD3N_35 Sch=BTN2
# set_property -dict { PACKAGE_PIN L19    IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L9P_T1_DQS_AD3P_35 Sch=BTN3
