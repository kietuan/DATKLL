...
## Switches
#set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { Dmem }]; #IO_L7N_T1_AD2N_35 Sch=SW0
...
set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { CPU_executing }]; #IO_L6P_T0_34 Sch=LED1
set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { CPU_finish_execution }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
# set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { buffer_full }]; #IO_L23P_T3_35 Sch=LED3
