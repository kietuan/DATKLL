...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../RISCV-with-UART.gen/sources_1/bd/clock_wizard/ipshared/30ef" +incdir+"../../../../RISCV-with-UART.gen/sources_1/bd/clock_wizard/ipshared/30ef" \
